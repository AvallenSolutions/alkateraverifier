...
export function Toast({
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-20 left-1/2 z-50 flex w-[calc(100%-3rem)] max-w-md -translate-x-1/2 items-start justify-between gap-3 rounded-md border border-border border-l-[3px] border-l-tone-lost-ink bg-surface px-4 py-3 shadow-float"
    >
